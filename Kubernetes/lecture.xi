...
Воркер ноды - машина на кластере Kubernetes. Тут запускаются приложения. На каждой ноде есть кублет.  

Абстракции Kubernetes (YAML): .
  POD - минимальная абстракция, с которой работает Kubernetes. Тут запускаются приложения. .
  Это группа контейнеров с общими разделами, запускаемых как единое целое.
